...
class RecordTypeTest {
  ...
  void testSelectRecord() {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      ...
      assertEquals("https://www.google.com", prop.getURL());
    }
  }
  ...
  void testInsertRecord() {
    ...
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      ...
      assertEquals("https://mybatis.org", prop.getURL());
    }
  }
  ...
  void testSelectNestedRecord() {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      ...
      assertEquals(Integer.valueOf(100), item.getId());
      assertEquals(new Property(1, "Val1", "https://www.google.com"), item.getProperty());
    }
  }
}
